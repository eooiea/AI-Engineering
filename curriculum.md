...
본 교육 과정은 **Antigravity IDE** 환경에서 최근 AI 엔지니어링의 핵심 트렌드인 **Model Context Protocol (MCP)**, **커스텀 에이전트 스킬**, **멀티 에이전트 오케스트레이션**, **평가 하네스(Evaluation Harness)**, 그리고 **Antigravity SDK**를 실습하며 마스터할 수 있도록 설계된 종합 커리큘럼입니다.
